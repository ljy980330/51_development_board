...
#define TX_ADR_WIDTH    5   	// 5 单位的Tx地址宽度
#define RX_ADR_WIDTH    5   	// 5 单位的Rx地址宽度
#define TX_PLOAD_WIDTH  32  	// 32 单位的Tx地址宽度
#define RX_PLOAD_WIDTH  32  	// 32 单位的Rx地址宽度
...
/*******************************************************************************
* 函 数 名         : NRF24SPI_Send_Byte
* 函数功能		   : 发送一字节[MOSI和MISO数据传递]
*******************************************************************************/
uchar NRF24SPI_Send_Byte(uchar dat)
{
  	uchar i;
...
/*******************************************************************************
* 函 数 名         : uchar SPI_Read
* 函数功能		   : NRF24L01的SPI时序,读取指定寄存器的内容
*******************************************************************************/
uchar SPI_RD_Reg(uchar reg)
{
	uchar reg_val;
...
/*******************************************************************************
* 函 数 名         : uchar SPI_Write
* 函数功能		   : NRF24L01的SPI时序,写入指定寄存器的内容
*******************************************************************************/
uchar SPI_WR_Reg(uchar reg, uchar value)
{
	uchar status;
...
/*******************************************************************************
* 函 数 名         : uint SPI_Write_Buf(uchar reg, uchar *pBuf, uchar Len
* 函数功能		   : 用于写数据
				     reg:为寄存器地址
//				  	 pBuf：为待写入数据地址
//					 uchars：写入数据的个数
...
/*******************************************************************************
* 函 数 名         : unsigned char nRF24L01_RxPacke
